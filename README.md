...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/D3V-ALPHA)
...
- Gained hands-on experience in operating systems, file systems, process management and virtualization by setting up Type 1 and Type 2 hypervisors
- Successfully deployed a full-stack web application on Ubuntu server configured with SSH, Nginx and virtual machines
- Mastered Linux commands, permissions and SSH key management for local network access
- Collaborated closely with team members on file organization and server setup tasks
...
- Strong foundation in software engineering with focus on practical skills and industry relevance
- Proficient in polyglot programming with hands-on experience across multiple languages
- Experienced with DevOps tools — Docker, Jenkins, AWS, CI/CD pipelines
- Developed strong project management, team-building and communication skills
